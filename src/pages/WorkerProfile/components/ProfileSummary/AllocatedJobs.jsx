...
export const AllocatedJobs = ({ worker }) => {
    ...
    const location = `${contactDetails.city}${contactDetails?.state && ', ' + contactDetails.state}`

    return (
        <Container className={classes.root}>
            <Typography className={classes.title}>Current Role</Typography>
            <Box p={1} mb={3} className={clsx(classes.roundedBorderBox, classes.solidBackground)}>
                <Typography className={clsx(classes.bottomSpacing, classes.boldTitle)}>{jobType}</Typography>
                <Box
                    sx={{
                        display: 'flex',
                        alignItems: 'center',
            ...
            <Box p={1} className={clsx(classes.roundedBorderBox)}>
                ...
                >
                    ...
                    >
                        <Typography color="textSecondary" className={clsx(classes.subTitle, classes.statusDot)}>
                            {' '}
                            •{' '}
                        </Typography>
