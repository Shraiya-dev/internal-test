...
export const workerProfileOptions = [
    {
        value: 'HELPER',
        label: 'Helper',
    },
...
export const yesOrNoOtherOptions = [
    {
        value: 'YES',
        label: 'Yes',
    },
...
export const wageEarnedOptions = [
    {
        value: '< 450',
        label: 'Less than Rs. 450',
    },
    {
        value: '450-500',
        label: 'Rs. 450 - Rs. 500',
...
export const currentlyOperationalCities = [
